	...
	<body>
		...
		<section class="container">
			<ol class="breadcrumb">
				...
				<li><a href="ListaDespesa?numeroProcesso=${numeroProcesso}&cliente=${cliente}">Listar Despesas</a></li>
					...
					<div class="panel-body">
						<form class="form-horizontal" role="form" method="get"
							...
							<div class="form-group">
								...
								<div class="col-md-7">
									<input type="text" class="form-control" id="numeroProcesso"
										name="numeroProcesso" value="${numeroProcesso}"
										readonly>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<select class="form-control" id="tipoDespesa" name="tipoDespesa" readonly>
										<c:forEach items="${listaTiposDespesa}" var="listaTipos">
											<c:if test="${listaTipos.codigo == codigoTipoDespesa}">
												<option value="${listaTipos.codigo}" selected="selected">${listaTipos.descricao}</option>
											</c:if>
										</c:forEach>
									</select>
								</div>
							...
							<div class="form-group">
								<label for="observacaoDespesa" class="col-sm-2 control-label">Observações:</label>
								<div class="col-md-7">
