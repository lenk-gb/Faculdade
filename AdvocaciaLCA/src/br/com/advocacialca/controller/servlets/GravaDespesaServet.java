...
/**
 * Servlet implementation class GravaDespesaServet
 */
@WebServlet("/GravaDespesa")
public class GravaDespesaServet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GravaDespesaServet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Pegando vaores atraves do formulário
		...
		int codigoLancamento = Integer.parseInt(codigoTexto);
		...
		objDespesa.setCodigo(codigoLancamento);
		objDespesa.setData(data);
		objDespesa.setValor(valorDespesa);
		objDespesa.setObservacao(observacao);
		
		try {
			DespesaBO.alterarDespesa(objDespesa);
			
			String mensagem = "Alteração efetivada com sucesso, processo número: "+ objDespesa.getProcesso().getNumeroProcesso();
