...
/**
 * Servlet implementation class EditarDespesaServlet
 */
@WebServlet("/AlteraDespesa")
public class AlteraDespesaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AlteraDespesaServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String codigoTipoDespesa = request.getParameter("codigoTipoDespesa");
		...
		try {
			...
			request.setAttribute("codigoTipoDespesa", codigoTipoDespesa);
			request.setAttribute("codigo", codigoLancamento);
			
			request.getRequestDispatcher("alteraDespesa.jsp").forward(request, response);
